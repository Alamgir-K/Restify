...
from ..serializers.comment import UserRatingSerializer, CommentChainSerializer, UserCommentSerializer
...
class CreateCommentView(CreateAPIView):
    ...
    def perform_create(self, serializer):
        ...
        serializer.save(user=user, owner=owner, reservation=reservation, comment=new_comment)
...
class CreateUserRating(CreateAPIView):
    ...
    def perform_create(self, serializer):
        ...
        request = Request.objects.filter(user=user, reservation__property__owner=host, reservation__status="Completed")
        if not request:
