...
class UserRating(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='ratings_given', default=None)
    host = models.ForeignKey(User, on_delete=models.CASCADE, related_name='ratings_given', default=None)
